...
//
// The "path" is the JSON pointer path from the top of the original
// schema obj to reach the target schema.
// ******************************************************************
...
SchemaRegistry.prototype._missingRefsForSchema = function(schema) {
  ...
  allRefs.forEach(function(ref) {
    if (ref[0] !== '#') {
      ...
      if (!this._schemas.hasOwnProperty(uriObj.baseUri)) {
...
SchemaRegistry.prototype._registerImpl = function(schema, id, _resolutionScope)
{
  ...
  if (id) {
    ...
    if (this._schemas.hasOwnProperty(resolvedId)) { return; }
...
SchemaRegistry.prototype.get = function(id) {
  ...
  if (this._schemas.hasOwnProperty(id)) {
